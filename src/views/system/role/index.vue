...
import { RolePageVO, RoleInfo, RoleQuery } from "@/api/system/role/types";
 ...
 * 分页参数
 */
const pageQueryParams = reactive<PageQuery<RoleQuery>>({
  page: 1,
  pageSize: 10,
  params: queryParams
});
